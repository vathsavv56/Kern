...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center p-0 md:p-4 lg:p-8 font-['Poppins'] snap-center">
      <div className="bg-white w-full md:max-w-5xl md:h-175 min-h-screen md:min-h-0 h-auto md:rounded-[40px] shadow-2xl overflow-hidden flex flex-col md:grid md:grid-cols-2 p-0 md:p-2 relative">
        <div className="relative w-full md:h-full h-48 md:rounded-4xl rounded-b-4xl md:rounded-t-4xl overflow-hidden flex flex-col items-center justify-center md:justify-start text-white p-6 md:p-8 bg-linear-to-b from-gray-900 via-[#8B2323] to-[#FF4500] shrink-0 transition-all duration-500 ease-in-out">
          ...
          <div className="z-10 text-center md:mb-20 space-y-4 hidden md:block">
            ...
            <p className="text-red-100/90 text-lg max-w-xs mx-auto font-light">
              Experience the best react Components
            </p>
          </div>
        ...
        <div className="h-full w-full bg-white px-6 md:px-12 lg:px-16 py-8 flex flex-col flex-1 overflow-y-auto">
          ...
          >
            <ArrowLeft
              size={24}
              className="hover:cursor-pointer hover:bg-50/80 rounded-full "
            />
          </button>
          ...
          >
            <div className="mb-6 md:mb-8">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 tracking-tighter">
              ...
              <p className="text-gray-500 text-sm font-medium">
                ...
                <button
                  ...
                  className="text-black font-bold underline decoration-1 hover:text-gray-700 underline-offset-2 transition-colors hover:cursor-pointer"
                >
              ...
              <div className="group">
                ...
                {!isLogin && formData.password.length > 0 && (
                  <div className="mt-2 flex gap-1">
                    <div
                      className={`h-1 flex-1 rounded-full ${formData.password.length > 4 ? "bg-green-500" : "bg-gray-200"} transition-colors`}
                    ></div>
                    <div
                      className={`h-1 flex-1 rounded-full ${formData.password.length > 6 ? "bg-green-500" : "bg-gray-200"} transition-colors`}
                    ></div>
                    <div
                      className={`h-1 flex-1 rounded-full ${formData.password.length > 8 ? "bg-green-500" : "bg-gray-200"} transition-colors`}
                    ></div>
                  </div>
                )}
              </div>
